...
os.mkdir("SingleEle_v1",0755)
os.chdir("SingleEle_v1")
...
SR1_SingleElePt.SetTitle("EleChannel SR1;ele_Pt (GeV);")
#gPad.SetLogy()
#gPad.Update()
...
SR2_SingleElePt.SetTitle("EleChannel SR2;ele_Pt (GeV);")
#gPad.SetLogy()
#gPad.Update()
c.Print("SR2_SingleEle.pdf","pdf")
