...
os.mkdir("Output_SingleEle_v314",0755)
os.chdir("Output_SingleEle_v314")
...
SinglePhoSigmaIEtaIEta = ROOT.TH1F("SinglePhoSigmaIEtaIEta","SinglePhoSigmaIEtaIEta",100,0,1000)
SinglePhoSigmaIPhiIPhi = ROOT.TH1F("SinglePhoSigmaIPhiIPhi","SinglePhoSigmaIPhiIPhi",100,0,1000)
...
SinglePhoSigmaIEtaIEta.SetTitle("SR1:;#gamma_i#{eta}i#{eta};")
#gPad.SetLogy()
#gPad.Update()
...
SinglePhoSigmaIPhiIPhi.SetTitle("SR1:;#gamma_i#{phi}i#{phi};")
#gPad.SetLogy()
#gPad.Update()
